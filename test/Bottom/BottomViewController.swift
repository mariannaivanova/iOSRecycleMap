...
class BottomViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        view.addSubview(buttonsStack1)
        buttonsStack1.snp.makeConstraints { make in
            make.top.equalToSuperview().offset(40)


        }
        view.addSubview(buttonsStack2)
        ...
        view.addSubview(timeDropDownLabel)
        timeDropDownLabel.snp.makeConstraints { make in
            make.top.equalTo(timeLabel.snp.bottom).offset(10)
            make.left.equalTo(timeLabel)
        }

        view.addSubview(timeDropDownButton)
        ...
        view.addSubview(availableDropDownLabel)
        ...
        view.addSubview(availableDropDownButton)
    ...
    private lazy var availableDropDownButton: UIButton = {
        ...
        //time.setImage(UIImage(named: "time"), for: .normal)
